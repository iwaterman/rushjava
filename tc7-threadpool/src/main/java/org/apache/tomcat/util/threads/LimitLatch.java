...
public class LimitLatch {
	...
	private static final Logger log = Logger.getLogger(LimitLatch.class.getName());
	...
	public void countUpOrAwait() throws InterruptedException {
		...
		log.info("Counting up[" + Thread.currentThread().getName() + "] latch=" + getCount());
	...
	public long countDown() {
		...
		log.info("Counting down[" + Thread.currentThread().getName() + "] latch=" + result);
