...
/**
 * How to open a direct connection using {@link ClientConnectionOperator
 * ClientConnectionOperator}. This exemplifies the <i>opening</i> of the
 * connection only. The subsequent message exchange in this example should not
