...
/**
 * Prints version information for debugging purposes. This can be used to verify
 * that the correct versions of the HttpComponent JARs are picked up from the
 * classpath.
 * 
 * 
 */
public class PrintVersionInfo {
	...
	private final static String[] MODULE_LIST = { "org.apache.http", // HttpCore
	 ...
	 * 
	 * @param args
	 *            command line arguments. Leave empty to print version
	 *            information for the default packages. Otherwise, pass a list
	 *            of packages for which to get version info.
	 */
