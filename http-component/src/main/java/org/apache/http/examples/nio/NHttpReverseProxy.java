...
public class NHttpReverseProxy {
	...
	public static void main(String[] args) throws Exception {
		...
		// Target host
		HttpHost targetHost = new HttpHost(uri.getHost(), uri.getPort() > 0 ? uri.getPort() : 80,
		...
		HttpProcessor outhttpproc = new ImmutableHttpProcessor(new HttpRequestInterceptor[] { new RequestContent(),
	...
	static class ProxyRequestConsumer implements HttpAsyncRequestConsumer<ProxyHttpExchange> {
		...
		public void requestReceived(final HttpRequest request) {
			synchronized (this.httpExchange) {
				...
				this.executor.execute(new ProxyRequestProducer(this.httpExchange), new ProxyResponseConsumer(
						this.httpExchange), this.connPool);
			}
		}
