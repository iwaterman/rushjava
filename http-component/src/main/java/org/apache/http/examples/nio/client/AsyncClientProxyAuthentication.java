 ...
 * exchange over a secure connection tunneled through an authenticating proxy.
 */
public class AsyncClientProxyAuthentication {

	public static void main(String[] args) throws Exception {
		CredentialsProvider credsProvider = new BasicCredentialsProvider();
		credsProvider.setCredentials(new AuthScope("someproxy", 8080), new UsernamePasswordCredentials("username",
				"password"));
