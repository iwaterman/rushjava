...
public class NioQuickStart {
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			// Execute request
			final HttpGet request1 = new HttpGet(ACCESS_URL);
			request1.setHeader("time", "5000");
			...
			final HttpGet request2 = new HttpGet(ACCESS_URL);
			request2.setHeader("time", "10000");
